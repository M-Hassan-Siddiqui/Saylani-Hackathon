...
function SignupScreen({ navigation }) {
  ...
  const [Contact, onChangeNumber] = React.useState(null);
        ...
        <View style={styles.inner}>
          ...
          <View style={{}}>
            <View style={styles.inputSectionStyle}>
              ...
              />
              <Image
                source={require('../assets/images/User.png')} //Change your icon image here
                style={{
                  padding: 10,
                  margin: 5,
                  height: 25,
            ...
            />
              <Image
                source={require('../assets/images/contact.png')} //Change your icon image here
                style={{
                  padding: 10,
                  margin: 5,
                  height: 25,
          ...
          <View style={{ justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Text style={styles.h6}>Already have an account? Login</Text>
            </TouchableOpacity>
